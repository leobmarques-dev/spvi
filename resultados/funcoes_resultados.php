...
echo "</ol>";
		...
		if (isset($_GET["participante"])){
			...
			// Escreve no arquivo
			$CSVCabecalho = 	"Data;Participante;VI;NumTentativas;CliquesOP1;CliquesOP2;S+OP1;S+OP2;VIsOP1;VIsOP2;CliquesRef_OP1;CliquesRef_OP2;momentoS+OP1;momentoS+OP2;COD_Sessao;COD_OP1;COD_OP2;TempoTotal;NomeOp1;NomeOp2;OperandoEscolhido;ContagemReforco;OPTravado;NomeArqCSV"."\n";
